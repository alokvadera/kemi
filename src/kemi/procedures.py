...
def remember_procedure(
    ...
    *,
    ...
    """
    if not steps:
        raise ValueError("steps cannot be empty — there is nothing to remember")
...
def recall_procedures(
    ...
    *,
    ...
    Returns:
        List of :class:`~kemi.models.MemoryObject` instances with
    ...
    if not query or not query.strip():
        raise ValueError("query cannot be empty — what procedure should kemi search for?")
    if top_k < 1:
